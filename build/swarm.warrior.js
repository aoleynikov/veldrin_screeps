...
const hostile_entities = room => {
  [].concat.apply([], [FIND_HOSTILE_CREEPS, FIND_HOSTILE_STRUCTURES, FIND_HOSTILE_SPAWNS, FIND_HOSTILE_CONSTRUCTION_SITES, FIND_HOSTILE_POWER_CREEPS].map(find => {
...
const body = (core, room) => {
  ...
  return build_body(base, extension, core_room.energyCapacityAvailable, size(core));
};
