...
var spawns = {
  'Earth': [].concat.apply([], [metropolia('Earth', 'W37S11'), colony('ISS', 'W37S12', 'W37S11'), colony('Moon', 'W36S11', 'W37S11'), colony('Deimos', 'W35S11', 'W37S11'), metropolia('Mars', 'W38S11'), metropolia('Saturn', 'W36S13'), metropolia('Venus', 'W34S12'), metropolia('Jupiter', 'W39S13'), common()]),
  ...
  'Venus': [].concat.apply([], [metropolia('Venus', 'W34S12'), colony('Titan', 'W35S12', 'W34S12'), colony('Oberon', 'W35S13', 'W34S12'), metropolia('Saturn', 'W36S13'), colony('Himalia', 'W36S12', 'W34S12'), metropolia('Earth', 'W37S11'), metropolia('Mars', 'W38S11'), colony('Moon', 'W36S11', 'W37S11'), colony('Deimos', 'W35S11', 'W37S11'), common()]),
  ...
  'Saturn': [].concat.apply([], [metropolia('Saturn', 'W36S13'), colony('Himalia', 'W36S12', 'W34S12'), colony('Titan', 'W35S12', 'W34S12'), colony('Oberon', 'W35S13', 'W34S12'), metropolia('Venus', 'W34S12'), colony('Deimos', 'W35S11', 'W37S11'), common()])
};
module.exports = {
  rooms: {
    'W37S11': 'Earth',
