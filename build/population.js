...
var Common = common();
var spawns = {
  'Earth': [].concat.apply([], [Earth, ISS, Moon, Mars, Deimos, Io, Phobos, Phoebe, Titan, Europa, Oberon, Amalthea, Vodka, Venus, Jupiter, Saturn, Common]),
  'Mars': [].concat.apply([], [Mars, Phobos, Phoebe, Amalthea, Earth, Europa, Jupiter, Enceladus, Io, Callisto, Common]),
  'Venus': [].concat.apply([], [Venus, Titan, Oberon, Ganymede, Saturn, Vodka, Himalia, Deimos, Moon, Earth, Common]),
  'Jupiter': [].concat.apply([], [Jupiter, Callisto, Europa, Enceladus, Amalthea, Io, Phoebe, Mars, Earth, ISS, Vodka, Common]),
  'Saturn': [].concat.apply([], [Saturn, Himalia, Titan, Oberon, Venus, Deimos, Ganymede, Moon, Earth, Vodka, Common])
};
module.exports = {
  rooms: {
    'W37S11': 'Earth',
