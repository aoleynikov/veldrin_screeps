...
var Common = common();
var spawns = {
  'W38S27': [].concat.apply([], [Main, Abaddon, Kunkka, Bristleback, Clockwerk, DragonKnight, Enigma, FacelessVoid, Leshrak, Mirana, Necrophos, Gyrocopter, Common]),
  ...
  'W36S27': [].concat.apply([], [Clockwerk, Gyrocopter, Bristleback, Leshrak, Main, Abaddon, DragonKnight, Enigma, FacelessVoid, Common])
};
module.exports = {
  spawns: spawns
};