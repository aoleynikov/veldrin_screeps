...
var Common = common();
var spawns = {
  'W2S57': [].concat.apply([], [Main, Bristleback, Gyrocopter, Enigma, Abaddon, Furion, Clockwerk, Doom, Common]),
  'W4S57': [].concat.apply([], [Clockwerk, Abaddon, Doom, Furion, Enigma, Main, Bristleback, Gyrocopter, Common])
};
module.exports = {
  spawns: spawns
};